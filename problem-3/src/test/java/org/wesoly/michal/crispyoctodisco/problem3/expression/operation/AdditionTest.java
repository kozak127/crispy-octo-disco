...
public class AdditionTest {
    ...
    private static Stream<Arguments> provideApplyParameters() {
        return Stream.of(
                Arguments.of(getStack(List.of(10f, 10f)), getStack(List.of(20f))),
                Arguments.of(getStack(List.of(10.10f, 10.10f)), getStack(List.of(20.20f))),
                Arguments.of(getStack(List.of(10.10f, 10f)), getStack(List.of(20.10f))),
                Arguments.of(getStack(List.of(10f, 10f, 10f)), getStack(List.of(10f, 20f)))
        );
    }
