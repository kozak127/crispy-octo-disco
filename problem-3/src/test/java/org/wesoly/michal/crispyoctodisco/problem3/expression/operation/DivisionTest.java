...
public class DivisionTest {
    ...
    private final Operation operation = new Division();
    ...
    private static Stream<Arguments> provideApplyParameters() {
        return Stream.of(
                Arguments.of(getStack(List.of(10f, 10f)), getStack(List.of(1f))),
                Arguments.of(getStack(List.of(10.10f, 10.10f)), getStack(List.of(1f))),
                Arguments.of(getStack(List.of(10.10f, 10f)), getStack(List.of(1.01f))),
                Arguments.of(getStack(List.of(10f, 10f, 10f)), getStack(List.of(10f, 1f)))
        );
    }
